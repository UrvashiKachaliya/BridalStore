...
export default function NewIn() {
  return (
    <div>
        <Header/>
        <div style={{backgroundImage:`url(${banner3})`,backgroundSize:"cover",backgroundPosition:"center",height:"80vh",position:"relative"}}>
        <p style={{color:"black", textTransform:"uppercase",fontSize:"2rem",position:'absolute',bottom:"5%",right:"3%"}}><span className='fw-bold'>NEW</span> Collection</p>
        </div>
